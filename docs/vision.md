...
**RESOLVED 2026-07-29 → `.decisions/factions.md#human-survivor-faction`:** adopted, in the synthesis form described below — scattered crew from a small beacon-response mission, found in **tier 2**, as their own faction class. Tier-1 solitude is explicitly preserved: survivors do not appear during crash/stripped/hunted. The "against" argument was not dismissed but recorded as a standing guard — survivors must never become the faction that *explains* the ring, or they dilute the alienness the aesthetic depends on.

**Original open tension — companions/survivors (2026-07-22, now resolved above):** does Protagonist One encounter other human survivors from the same ship or mission? For: justifies a player base (or bases), gives the player their own faction dynamic. Against: dilutes the solitary "stripped, alone, prey" framing of tier 1. Not resolved — one synthesis worth weighing, not adopted: if the beacon was answered by a small response mission rather than a lone ship, scattered crew could be found *later*, during tier 2, recontextualizing "discover people" as sometimes discovering your own people among the natives — without softening tier-1 solitude.
